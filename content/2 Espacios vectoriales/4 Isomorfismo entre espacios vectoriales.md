...
-  $f(\bar{u}_1 + \bar{u}_2) = f(\bar{u}_1) + f(\bar{u}_2) \quad ; \quad \forall \, \bar{u}_1 \text{ y } \bar{u}_2 \in U$
-  $f(\alpha \bar{u}) = \alpha f(\bar{u}) \quad ; \quad \forall \, \bar{u} \in U \text{ y } \forall \, \alpha \in K$
